-- Syntax-Korrektur für H2/Standard-SQL
...
INSERT INTO question (question_id, question_set_id, question_type, start_text, image_url, end_text, allows_multiple, points) VALUES (18, 1, 'MC', 'Wie sollte die Mannheimer Haushaltsgeräte KG im Falle eines beginnenden Abschwungs agieren?(2 Antworten)', NULL, NULL, true, 2);
...
INSERT INTO question (question_id, question_set_id, question_type, start_text, image_url, end_text, allows_multiple, points) VALUES (19, 1, 'MC', 'Auf einem Markt treffen Angebot und Nachfrage aufeinander.Bei einem bestimmten Preis sind angebotene Menge und nachgefragte Menge genau gleich groß.', NULL, NULL, false, 1);
...
INSERT INTO question (question_id, question_set_id, question_type, start_text, image_url, end_text, allows_multiple, points) VALUES (36, 1, 'MC', 'Am 28.10.20XX kündigt Mina Stiller (38 Jahre, seit 11 Jahren im Unternehmen) fristgerecht zum nächstmöglichen Termin.Nennen Sie das Datum, an dem Frau Stiller frühestens eine neue Stelle antreten kann.', NULL, NULL, false, 1);
...
INSERT INTO question (question_id, question_set_id, question_type, start_text, image_url, end_text, allows_multiple, points) VALUES (40, 1, 'MC', 'Immer wieder fragen Kunden nach einer weiteren Entwicklung vernetzter Haushaltsgeräte.Bundesweit gibt es neben der MaHaG KG nur noch drei weitere Hersteller dieser zukunftsweisenden Technologie.', NULL, NULL, false, 1);
...
INSERT INTO question (question_id, question_set_id, question_type, start_text, image_url, end_text, allows_multiple, points) VALUES (42, 1, 'MC', 'Die Wirtschaftsordnung der Bundesrepublik Deutschland bezeichnet man als „Soziale Marktwirtschaft“.Besonderes Merkmal dieser Wirtschaftsordnung ist ein funktionierender Markt. Welche Eigenschaften und Entwicklungen zeichnen diesen Markt aus?', NULL, NULL, false, 1);
...
INSERT INTO question (question_id, question_set_id, question_type, start_text, image_url, end_text, allows_multiple, points) VALUES (348, 18, 'GAP', 'public static void main(String... args) {   int a = 5;   String s = new String("Hello");}Die Variable a wird im _ gespeichert und die Referenzvariable s wird im _ gespeichert.Das eigentliche String-Objekt wird im _ gespeichert.', NULL, NULL, FALSE, 3);
...
INSERT INTO question (question_id, question_set_id, question_type, start_text, image_url, end_text, allows_multiple, points) VALUES (351, 18, 'GAP', 'switch(x) {    default:        System.out.println("Hello");}Akzeptable Typen für x sind _ und _.', NULL, NULL, FALSE, 3);
...
INSERT INTO question (question_id, question_set_id, question_type, start_text, image_url, end_text, allows_multiple, points) VALUES (352, 18, 'MC', '1  double d1 = 5f;2  double d2 = 5.0;3  float f1 = 5f;4  float f2 = 5.0;In welcher Zeile tritt zuerst ein Compilerfehler auf?', NULL, NULL, FALSE, 3);
...
INSERT INTO question (question_id, question_set_id, question_type, start_text, image_url, end_text, allows_multiple, points) VALUES (356, 19, 'MC', 'Was ist gemäß Clean-Code-Prinzipien falsch an dieser Methode?Mehrere Antworten sind korrekt.public static void doStuff(int a, int b, boolean flag, String s) {    int x = a + b;    if(flag) {        x *= 2;        System.out.println(s + x);    } else {        for(int i=0;i<3;i++) {            x += i;            System.out.println(x);        }    }}', NULL, NULL, TRUE, 4);
